...
<center>
    ...
    <form name="form1" method="post" id="form1"  action="${pageContext.request.contextPath}/desktop/news/pidSelectNewsLabel.do"  >
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                ...
                <td width="86%" class="td_02">
                    <select name="pid" class="input" onchange="submitForm();" style="width:99% ">
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <c:forEach items="${page.datas}" var="nl">
                <tr>
                    ...
                    <td class="td07"><a href="" onClick="javascript:windowOpen('${pageContext.request.contextPath}/desktop/news/selectNewsLabelId.do?id=${nl.id}&pageno=${page.pageno} ','','',670,260,'no','yes','100','100')">修改</a>
                    </td>
                </tr>
            </c:forEach>
            <tr>
